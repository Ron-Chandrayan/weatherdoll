              ...
              .then(response=>{
                return response.json();
                  ...
                  if(icon==="partly-cloudy-night"){
                    console.log("hello");
                    first.style.background="url(cloudynight.jpg)";
                    first.style.backgroundRepeat="no-repeat";
                    first.style.backgroundSize="cover";

                    second.style.background="url(cloudynight2.jpg)"
                    second.style.backgroundRepeat="no-repeat";
                    second.style.backgroundSize="cover";
                  }
                  else if(icon==="partly-cloudy-day"){
                    first.style.background="url(partlycloudy.jpg)";
                    first.style.backgroundRepeat="no-repeat";
                    first.style.backgroundSize="cover";

                    second.style.background="url(partlycloudy2.jpg)"
                    second.style.backgroundRepeat="no-repeat";
                    second.style.backgroundSize="cover";
                  }
                  else if(icon==="clear-night"){
                    first.style.background="url(nightsky.jpg)";
                    first.style.backgroundRepeat="no-repeat";
                    first.style.backgroundSize="cover";

                    second.style.background="url(nightsky2.jpg)"
                    second.style.backgroundRepeat="no-repeat";
                    second.style.backgroundSize="cover";
                  }
                  else if(icon==="cloudy"){
                    first.style.background="url(cloudy.jpg)";
                    first.style.backgroundRepeat="no-repeat";
                    first.style.backgroundSize="cover";

                    second.style.background="url(cloudy2.jpg)"
                    second.style.backgroundRepeat="no-repeat";
                    second.style.backgroundSize="cover";
                  }
                  else if(icon==="clear-day"){
                    first.style.background="url(clearsky.jpg)";
                    first.style.backgroundRepeat="no-repeat";
                    first.style.backgroundSize="cover";

                    second.style.background="url(clearsky.jpg)"
                    second.style.backgroundRepeat="no-repeat";
                    second.style.backgroundSize="cover";
                  }
                  else if(icon==="fog"){
                    first.style.background="url(fog1.jpg)";
                    first.style.backgroundRepeat="no-repeat";
                    first.style.backgroundSize="cover";

                    second.style.background="url(fog2.jpg)"
                    second.style.backgroundRepeat="no-repeat";
                    second.style.backgroundSize="cover";
                  }
                  else if(icon==="rain"){
                    first.style.background="url(rain.jpg)";
                    first.style.backgroundRepeat="no-repeat";
                    first.style.backgroundSize="cover";

                    second.style.background="url(rain.jpg)"
                    second.style.backgroundRepeat="no-repeat";
                    second.style.backgroundSize="cover";
                  }
                  else if(icon==="snow"){
